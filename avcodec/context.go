...
func (c *CodecContext) Open(codec *Codec, d **Dictionary) avutil.ReturnCode {
	return avutil.NewReturnCode(int(C.avcodec_open2((*C.struct_AVCodecContext)(c), (*C.struct_AVCodec)(codec), (**C.struct_AVDictionary)(unsafe.Pointer(d)))))
}

// PktTimebase returns the packet timebase.
// C-Function: av_codec_get_pkt_timebase
func (c *CodecContext) PktTimebase() Rational {
...
func (c *CodecContext) SetPktTimebase(r Rational) {
...
func (c *CodecContext) CodecDescriptor() *CodecDescriptor {
	return (*CodecDescriptor)(C.av_codec_get_codec_descriptor((*C.struct_AVCodecContext)(c)))
}

// SetCodecDescriptor sets the CodecDescriptor.
// C-Function: av_codec_set_codec_descriptor
func (c *CodecContext) SetCodecDescriptor(d *CodecDescriptor) {
...
func (c *CodecContext) Lowres() int {
...
func (c *CodecContext) SetLowres(i int) {
...
func (c *CodecContext) SeekPreroll() int {
...
func (c *CodecContext) SetSeekPreroll(i int) {
...
func (c *CodecContext) ChromaIntraMatrix() *uint16 {
...
// C-Function: av_codec_get_chroma_intra_matrix
func (c *CodecContext) SetChromaIntraMatrix(t *uint16) {
...
func (c *CodecContext) AlignDimensions(w, h *int) {
...
func (c *CodecContext) AlignDimensions2(w, h *int, l []int) {
	C.avcodec_align_dimensions2((*C.struct_AVCodecContext)(c), (*C.int)(unsafe.Pointer(w)), (*C.int)(unsafe.Pointer(h)), (*C.int)(unsafe.Pointer(&l[0])))
}

// SendPacket sends a packet as input to the decoder.
// C-Function: avcodec_send_packet
func (c *CodecContext) SendPacket(pkt *Packet) avutil.ReturnCode {
	return avutil.NewReturnCode(int(C.avcodec_send_packet((*C.struct_AVCodecContext)(c), (*C.struct_AVPacket)(pkt))))
}

// ReceiveFrame receives a frame as output from the decoder.
// C-Function: avcodec_receive_frame
func (c *CodecContext) ReceiveFrame(frame *avutil.Frame) avutil.ReturnCode {
	return avutil.NewReturnCode(int(C.avcodec_receive_frame((*C.struct_AVCodecContext)(c), (*C.struct_AVFrame)(unsafe.Pointer(frame)))))
}

// SendFrame sends a frame as input to the encoder.
// C-Function: avcodec_send_frame
func (c *CodecContext) SendFrame(frame *avutil.Frame) avutil.ReturnCode {
	return avutil.NewReturnCode(int(C.avcodec_send_frame((*C.struct_AVCodecContext)(c), (*C.struct_AVFrame)(unsafe.Pointer(frame)))))
}

// ReceivePacket receives a packet as output from the decoder.
// C-Function: avcodec_receive_packet
func (c *CodecContext) ReceivePacket(pkt *Packet) avutil.ReturnCode {
	return avutil.NewReturnCode(int(C.avcodec_receive_packet((*C.struct_AVCodecContext)(c), (*C.struct_AVPacket)(pkt))))
}
...
func (c *CodecContext) DecodeSubtitle(s *Subtitle, g *int, a *Packet) int {
...
func (c *CodecContext) EncodeSubtitle(b *uint8, bs int, s *Subtitle) int {
...
func (c *CodecContext) DefaultGetFormat(f *avutil.PixelFormat) avutil.PixelFormat {
	return (avutil.PixelFormat)(C.avcodec_default_get_format((*C.struct_AVCodecContext)(c), (*C.enum_AVPixelFormat)(f)))
}
...
func (c *CodecContext) AudioFrameDuration(frameSize int) int {
	return int(C.av_get_audio_frame_duration((*C.struct_AVCodecContext)(c), C.int(frameSize)))
}
...
func (c *CodecContext) IsOpen() bool {
	return int(C.avcodec_is_open((*C.struct_AVCodecContext)(c))) != 0
}

// Parse is not yet completely implemented.
// C-Function: av_parser_parse2
// TODO
func (c *CodecContext) Parse(ctxtp *CodecParserContext, p **uint8, ps *int, b *uint8, bs int, pt, dt, po int64) int {
...
// TODO
func (c *CodecContext) ParserChange(ctxtp *CodecParserContext, pb **uint8, pbs *int, b *uint8, bs, k int) int {
	// TODO: implement correctly giving it a buffer, returning the output data and so on.
...
// RegisterCodecParser registers a CodecParser.
...
func (c *CodecContext) FromParameters(par *CodecParameters) avutil.ReturnCode {
	return avutil.NewReturnCode(int(C.avcodec_parameters_to_context((*C.AVCodecContext)(c), (*C.AVCodecParameters)(par))))
}

// ToParameters returns a CodecParameters instance from a CodecContext
// C-Function: avcodec_parameters_from_context
func (c *CodecContext) ToParameters() (*CodecParameters, avutil.ReturnCode) {
	par := &CodecParameters{}
	ret := int(C.avcodec_parameters_from_context((*C.AVCodecParameters)(par), (*C.AVCodecContext)(c)))
